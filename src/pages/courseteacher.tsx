...
const ControlButtonsEnroll = () => {
  if(role == "student")
  {
  }
  else
  {
    return <IonButton  expand="full" shape="round" fill="outline" onClick={() => history.push("/course/students",courseID)}>Enrolled Students</IonButton>
